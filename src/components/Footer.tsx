            ...
            <div style={{ display: 'flex', gap: '15px' }}>
              <div style={{ width: '56px', height: '55px', borderRadius: '50%', border: '1px solid rgba(255,255,255,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="11" height="22" viewBox="0 0 11 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M2.24991 21.1896V10.594H0V6.94252H2.24991V4.7502C2.24991 1.77135 3.52034 0 7.12981 0H10.1348V3.65187H8.25646C6.85139 3.65187 6.75844 4.16216 6.75844 5.11451L6.75333 6.9421H10.1561L9.75789 10.5936H6.75333V21.1896H2.24991Z" fill="white"/>
                </svg>
              </div>
              <div style={{ width: '56px', height: '55px', borderRadius: '50%', border: '1px solid rgba(255,255,255,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
