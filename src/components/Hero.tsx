...
export default function Hero() {
  return (
    <section style={{
      ...
      {/* Background Ellipses */}
      <div className="animate-rippleIn" style={{ animationDelay: '0.2s', position: 'absolute', width: '863px', height: '863px', left: 'calc(50% - 863px/2)', top: '507px', background: '#0A2A66', borderRadius: '50%' }} />
      <div className="animate-rippleIn" style={{ animationDelay: '0.4s', position: 'absolute', width: '805px', height: '805px', left: 'calc(50% - 805px/2)', top: '536px', background: '#082458', borderRadius: '50%' }} />
      <div className="animate-rippleIn" style={{ animationDelay: '0.6s', position: 'absolute', width: '753px', height: '753px', left: 'calc(50% - 753px/2)', top: '562px', background: '#061C45', borderRadius: '50%' }} />
      <div className="animate-rippleIn" style={{ animationDelay: '0.8s', position: 'absolute', width: '686px', height: '686px', left: 'calc(50% - 686px/2)', top: '595px', background: '#06193B', borderRadius: '50%' }} />
      <div className="animate-rippleIn" style={{ animationDelay: '1.0s', position: 'absolute', width: '622px', height: '622px', left: 'calc(50% - 622px/2)', top: '627px', background: '#041431', borderRadius: '50%' }} />
