  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        left: '-23px', top: '480px',
        background: '#0256EB', filter: 'blur(220px)', borderRadius: '50%'
      }} />

      <h2 style={{
        fontFamily: 'Inter', fontWeight: 600, fontSize: '48px',
        color: '#FFFFFF', textAlign: 'center', marginBottom: '24px', zIndex: 10
      }}>
        From Learning to Living in Germany
      </h2>
      <p style={{
        fontFamily: 'Inter', fontWeight: 400, fontSize: '24px',
        color: '#FFFFFF', textAlign: 'center', maxWidth: '586px', marginBottom: '80px', zIndex: 10
      }}>
        Discover how our students transformed their lives through German language learning.
      </p>

      <div style={{
        display: 'flex', gap: '40px', justifyContent: 'center', flexWrap: 'wrap', zIndex: 10
      }}>
        {testimonials.map((t, i) => (
          <div key={i} style={{
            ...
            <p style={{
              fontFamily: 'Inter', fontWeight: 400, fontSize: '24px',
              lineHeight: '32px', color: '#2E2E2E', flex: 1, marginTop: '10px', zIndex: 2
            }}>
              {t.text}
            </p>

            <div style={{ marginTop: 'auto' }}>
              <h4 style={{ fontFamily: 'Inter', fontWeight: 600, fontSize: '24px', color: '#2E2E2E' }}>
                {t.name}
              </h4>
              <span style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '16px', color: '#2E2E2E' }}>
                {t.location}
              </span>
            </div>
          </div>
      ...
      <div style={{ display: 'flex', gap: '40px', marginTop: '60px', zIndex: 10 }}>
        <button style={{
          width: '60px', height: '60px', borderRadius: '50%', border: '1px solid #FFFFFF',
