...
const STEPS = [
  {
    ...
    desc: "Begin with structured A1–B2 German language training."
  },
  {
    number: "02",
    title: "Build New Skills",
    desc: "Develop communication skills for real-world use."
  },
  {
    number: "03",
    title: "Prepare for Exams",
    desc: "Get guided support and practice for Goethe certification exams."
  },
  {
    number: "04",
    title: "Explore Opportunities",
    desc: "Take the next step towards study or career opportunities."
  }
];
    ...
    <main style={{ position: 'relative', width: '100%', overflowX: 'hidden' }}>
        ...
        <div style={{ 
          ...
          <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '32px', minWidth: '0' }}>
            ...
            <button className="btn-yellow" style={{
              width: '193px', height: '61px', fontSize: '20px'
            }}>
              Enquire Now
            </button>
          </div>
      ...
      <div style={{ position: 'relative', width: '100%', marginTop: '100px', paddingBottom: '100px', display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: '#FFFFFF' }}>
        ...
        <div style={{
          ...
          {/* Left Column: Text */}
          <div style={{ flex: '0 1 620px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <h2 style={{ fontFamily: 'Inter', fontWeight: 600, fontSize: '32px', lineHeight: '39px', color: '#2E2E2E' }}>
              {currentData.levelTitle}
            </h2>

            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <h3 style={{ fontFamily: 'Inter', fontWeight: 600, fontSize: '24px', color: '#2E2E2E' }}>
                Overview:
              </h3>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', width: '100%', maxWidth: '1440px', height: '100%' }}>
          ...
          <div style={{
            ...
            <div style={{ position: 'absolute', left: '210px', top: '48.5px', width: '139.01px', height: '0px', borderTop: '3px dashed #FFFFFF' }} />
            <div style={{ position: 'absolute', left: '534px', top: '48px', width: '139.01px', height: '0px', borderTop: '3px dashed #FFFFFF' }} />
            <div style={{ position: 'absolute', left: '873px', top: '48.5px', width: '139.01px', height: '0px', borderTop: '3px dashed #FFFFFF' }} />

            {STEPS.map((step, idx) => (
              <div key={idx} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px', width: '259px', zIndex: 10 }}>
                <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px' }}>
                  <h3 style={{ fontFamily: 'Inter', fontWeight: 600, fontSize: '32px', lineHeight: '39px', textAlign: 'center', color: '#FFFFFF', minHeight: '78px' }}>
                    {step.title}
                  </h3>
                  <p style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '24px', lineHeight: '29px', textAlign: 'center', color: '#FFFFFF' }}>
                    {step.desc}
                  </p>
                </div>
              </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontFamily: 'Inter', fontWeight: 600, fontSize: '48px', lineHeight: '60px', color: '#2E2E2E' }}>
              Ready to Start Your Journey?
            </h2>
            <p style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '24px', lineHeight: '32px', color: '#2E2E2E' }}>
